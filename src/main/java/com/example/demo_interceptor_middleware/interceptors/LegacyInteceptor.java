...
//OBBIETTIVO: bloccare le richieste all'endpoint "/legacy" e restituire un errore
@Component
public class LegacyInteceptor implements HandlerInterceptor {
    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        response.getWriter().write("This API endpoint is no longer available.");
